...
extern "C" {
	...
	CLI_API int getDataFromRemote(int fd, unsigned int addr, int size, int module, void* value);
	CLI_API int setDataFromRemote(int fd, unsigned int addr, int size, int module, void* value);
	CLI_API void sendMsg(int fd, char* msg);
#ifdef __cplusplus
}
#endif
