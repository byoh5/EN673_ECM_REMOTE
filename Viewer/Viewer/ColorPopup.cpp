...
{
    { RGB(0x00, 0x00, 0x00),	_T("검정색")			},
    { RGB(0xA5, 0x2A, 0x00),	_T("갈색")				},
    { RGB(0x00, 0x40, 0x40),	_T("어두운 올리브색")	},
    { RGB(0x00, 0x55, 0x00),	_T("어두운 녹색")		},
    { RGB(0x00, 0x00, 0x5E),	_T("암록청색")			},
    { RGB(0x00, 0x00, 0x8B),	_T("어두운 청색")		},
    { RGB(0x4B, 0x00, 0x82),	_T("남색")				},
    { RGB(0x28, 0x28, 0x28),	_T("어두운 회색")		},

    { RGB(0x8B, 0x00, 0x00),	_T("어두운 빨강색")		},
    { RGB(0xFF, 0x68, 0x20),	_T("오렌지색")			},
    { RGB(0x8B, 0x8B, 0x00),	_T("어두운 노란색")		},
    { RGB(0x00, 0x93, 0x00),	_T("녹색")				},
    { RGB(0x38, 0x8E, 0x8E),	_T("암록색")			},
    { RGB(0x00, 0x00, 0xFF),	_T("파란색")			},
    { RGB(0x7B, 0x7B, 0xC0),	_T("파란회색")			},
    { RGB(0x66, 0x66, 0x66),	_T("회색-40")			},

    { RGB(0xFF, 0x00, 0x00),	_T("빨간색")			},
    { RGB(0xFF, 0xAD, 0x5B),	_T("밝은 오렌지색")		},
    { RGB(0x32, 0xCD, 0x32),	_T("라임색")			}, 
    { RGB(0x3C, 0xB3, 0x71),	_T("바다 녹색")			},
    { RGB(0x7F, 0xFF, 0xD4),	_T("연한 녹청색")		},
    { RGB(0x7D, 0x9E, 0xC0),	_T("밝은 파란색")		},
    { RGB(0x80, 0x00, 0x80),	_T("보라색")			},
    { RGB(0x7F, 0x7F, 0x7F),	_T("회색-50")			},

    { RGB(0xFF, 0xC0, 0xCB),	_T("핑크색")			},
    { RGB(0xFF, 0xD7, 0x00),	_T("금색")				},
    { RGB(0xFF, 0xFF, 0x00),	_T("노란색")			},    
    { RGB(0x00, 0xFF, 0x00),	_T("밝은 녹색")			},
    { RGB(0x40, 0xE0, 0xD0),	_T("청록색")			},
    { RGB(0xC0, 0xFF, 0xFF),	_T("하늘색")			},
    { RGB(0x48, 0x00, 0x48),	_T("진한 보라색")		},
    { RGB(0xC0, 0xC0, 0xC0),	_T("밝은 회색")			},

    { RGB(0xFF, 0xE4, 0xE1),	_T("장미색")			},
    { RGB(0xD2, 0xB4, 0x8C),	_T("황갈색")			},
    { RGB(0xFF, 0xFF, 0xE0),	_T("베이지색")			},
    { RGB(0x98, 0xFB, 0x98),	_T("엷은 녹색")			},
    { RGB(0xAF, 0xEE, 0xEE),	_T("엷은 청록색")		},
    { RGB(0x68, 0x83, 0x8B),	_T("엷은 파란색")		},
    { RGB(0xE6, 0xE6, 0xFA),	_T("연보라색")			},
    { RGB(0xFF, 0xFF, 0xFF),	_T("흰색")				}
};
...
CColorPopup::CColorPopup(CPoint p, COLORREF crColor, CWnd* pParentWnd, UINT nID, 
                           ...
                           LPCTSTR szCustomText  /* = NULL */)
{
    ...
    CColorPopup::Create(p, crColor, pParentWnd, nID, szDefaultText, szCustomText);
}
...
void CColorPopup::Initialise()
{
    ...
    pLogPalette->palNumEntries = m_nNumColors; 
...
BOOL CColorPopup::Create(CPoint p, COLORREF crColor, CWnd* pParentWnd, UINT nID, 
                          LPCTSTR szDefaultText /* = NULL */,
                          LPCTSTR szCustomText  /* = NULL */)
{
...
void CColorPopup::SetWindowSize()
{
    ...
    CSize ScreenSize(::GetSystemMetrics(SM_CXVIRTUALSCREEN), ::GetSystemMetrics(SM_CYVIRTUALSCREEN));
