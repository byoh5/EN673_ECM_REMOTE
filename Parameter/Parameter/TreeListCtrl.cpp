...
//	pText			: Address of a string containing the item뭩 text.
//	nImage			: Index of the item뭩 image in the tree view control뭩 image list.
//	nSelImage		: Index of the item뭩 selected image in the tree view control뭩 image list.
//	nState			: Specifies values for the item뭩 states. SeeTree View Control Item States in the Platform SDK for a list of appropriate states.
...
//	hParent			: Handle of the inserted item뭩 parent.
