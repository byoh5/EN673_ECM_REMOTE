...
#define 	TVC_BOX					6					// 훧?re Farbe der Schaltfl?hen
...
#define 	TVGN_NEXTITEM			0x0013				// F? Enumerierung der Eintr?e
...
#define 	TVCF_FIXED				0x40000000			// Darf die Spaltenbreite ver?dert werden
...
#define 	TVAE_NEXTLINE			0x0001				// Nach Enter in die n?hste Zeile
#define 	TVAE_DBLCLICK			0x0002				// Editieren mit Doppelklick
#define 	TVAE_FULLWIDTH			0x0004				// Combobox ?er die volle Breite einblenden
#define 	TVAE_PTRLIST			0x0008				// Die Datenliste wird als Zeigerliste ?ergeben
...
#define 	TVAE_MODEPOS			0x0008				// Maske f? die Modusbits
#define 	TVIS_DISABLEBIT			0x8000				// Ist das State-Bit f?'s sperren der Auto-Edit-Option
...
#define 	TVS_EX_SINGLECHECKBOX	0x00002000			// 체크 박스에서 단순 선택
#define 	TVS_EX_STEPOUT			0x00004000			// Mit Cursor Edit und Checkboxen verlassen
#define 	TVS_EX_BITCHECKBOX		0x00008000			// 체크박스 모드(걍 모양;;) 변경.
#define 	TVS_EX_ITEMLINES		0x00010000			// 항목을 구분하는 선을 그림
#define 	TVS_EX_ALTERNATECOLOR	0x00020000			// 번갈아가며 색상 표시
#define 	TVS_EX_SUBSELECT		0x00040000			// Sub Item 선택이 가능하게 함.
#define 	TVS_EX_FULLROWMARK		0x00080000			// 선택한 행 전체에 색상(하이라이트)을 준다.
#define 	TVS_EX_TOOLTIPNOTIFY	0x00100000			// 툴팁에서 특정 쿼리 알림. (마우스 갔다대면 설명나옴)
...
#define 	TVS_EX_NOCOLUMNRESIZE	0x00800000			// Column Size 변경하지 않기.
#define 	TVS_EX_HIDEHEADERS		0x01000000			// 헤더 제거
#define 	TVS_EX_GRAYEDDISABLE	0x02000000			// Disable 상태일 때 회색으로 만들기.
...
#define 	TVS_EX_EDITCLICK		0x40000000			// 클릭으로 선택한 항목을 편집ㅎ나다.
#define 	TVS_EX_NOCURSORSET		0x80000000			// Bei VK_EDITCLK immer den gesammten Text w?len
#ifndef		TVS_EX_MULTISELECT
#define 	TVS_EX_MULTISELECT		0x00000002			// 여러 셀을 선택될 수 있게 한다.
#endif
#ifndef		TVS_EX_AUTOHSCROLL
#define		TVS_EX_AUTOHSCROLL      0x00000020			// 수평 스크롤바를 숨긴다.
#endif
