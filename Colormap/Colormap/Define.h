...
#define KEY_COLORMAPDLGLEFT		_T("ColormapDlgLeft")
#define KEY_COLORMAPDLGTOP		_T("ColormapDlgTop")

#define DEF_COLORMAPDLGLEFT		110
#define DEF_COLORMAPDLGTOP		390
...
#define tx_typr	COLOR
#define tx_addr	JTAG_UART_COLOR
