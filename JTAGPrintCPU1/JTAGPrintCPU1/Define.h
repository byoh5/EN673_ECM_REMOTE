...
#define DLG_JTAGPRINTCMDLOG		_T("JTAG Print Command Log")
...
#define JTAG_COMMAND		(0xF0010028)
...
#define JTAG_SHELL_NOTIFY_		0x00100000
#define JTAG_CPU_IRQ1_			0x02000000
#define JTAGCOMMAND_SIZE		64
...
#define KEY_JTAGPRINTCPU1DLGLEFT	_T("JTAGPrintCPU1DlgLeft")
#define KEY_JTAGPRINTCPU1DLGTOP		_T("JTAGPrintCPU1DlgTop")

#define DEF_JTAGPRINTCPU1DLGLEFT	510
#define DEF_JTAGPRINTCPU1DLGTOP		500

#define SEC_JTAGPRINT1				_T("JTAGPrintCPU1")
